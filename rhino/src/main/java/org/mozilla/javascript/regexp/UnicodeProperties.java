...
public class UnicodeProperties {
    ...
    public static final Map<String, Byte> PROPERTY_NAMES = Map.ofEntries(
    ...
    public static int lookup(String propertyOrValue) {
        ...
        // Check if it's a property=value format
        // match the regexp (ascii or _)+(=(ascii or _ or [0-9])+)?
        Matcher m =
    ...
    private static Character.UnicodeScript[] UnicodeScriptValues = Character.UnicodeScript.values();
